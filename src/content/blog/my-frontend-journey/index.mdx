...
Let's jump to the present. As a case study (and to boost our PR) I will go through apps I did at my current job. You can see a lineup from Streamlit prototypes (such as Electrostatics or Modeller) to a Flask + Dash dashboard in Explorer, up to the UI I'm currently most proud of: CHEESE Search. Note: you can learn more [here](https://www.deepmedchem.com/products-and-services/cheese-search) or [here](https://cheese-new.deepmedchem.com/about) about this molecular search.
